        ...
        <GridList cellheight={180} className={classes.gridList}>
          ...
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Education' subtitle="Because we are all students" actionIcon={
              <IconButton color="primary" data-category="education" onClick={(e) => this.setAndFetchData(e)}> <SvgIcon> <path d={Education}/> </SvgIcon> </IconButton>
            }>
            </GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
          ...
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Social' subtitle="Need some friends?" actionIcon={
              <IconButton color="primary" data-category="social"  onClick={(e) => this.setAndFetchData(e)}> <SvgIcon fontSize="large"> <path d={Social}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
          ...
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Charity' subtitle="There's always more to give" actionIcon={
              <IconButton color="primary" data-category="charity"  onClick={(e) => this.setAndFetchData(e)}> <SvgIcon> <path d={Charity}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Cooking' subtitle="Spend less time on Seamless and more in your kitchen" actionIcon={
                <IconButton color="primary" data-category="cooking"  onClick={(e) => this.setAndFetchData(e)}> <SvgIcon> <path d={Cook}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile>
            ...
            <GridListTileBar title='Relaxation' subtitle="Stressed? Just chill out" actionIcon={
                <IconButton color="primary" data-category="relaxation"  onClick={(e) => this.setAndFetchData(e)}> <SvgIcon> <path d={Spa}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Music' subtitle="Get them vibes" actionIcon={
              <IconButton color="primary" data-category="music"  onClick={(e) => this.setAndFetchData(e)}> <SvgIcon> <path d={Music}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
