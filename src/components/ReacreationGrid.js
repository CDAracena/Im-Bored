        ...
        <GridList cellheight={180} className={classes.gridList}>
          ...
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Education' subtitle="Because we are all students" actionIcon={
              <IconButton color="primary"> <SvgIcon> <path d={Education}/> </SvgIcon> </IconButton>
            }>
            </GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Recreational' subtitle="Who doesn't like having fun?" actionIcon={
              <IconButton color="primary"> <SvgIcon> <path d={BikeRide}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Social' subtitle="Need some friends?" actionIcon={
              <IconButton color="primary"> <SvgIcon fontSize="large"> <path d={Social}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='DIY' subtitle="Do It Yourself!" actionIcon={
              <IconButton color="primary"> <SvgIcon> <path d={Diy}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Charity' subtitle="There's always more to give" actionIcon={
              <IconButton color="primary"> <SvgIcon> <path d={Charity}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Cooking' subtitle="Spend less time on Seamless and more in your kitchen" actionIcon={
                <IconButton color="primary"> <SvgIcon> <path d={Cook}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile>
            ...
            <GridListTileBar title='Relaxation' subtitle="Stressed? Just chill out" actionIcon={
                <IconButton color="primary"> <SvgIcon> <path d={Spa}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Music' subtitle="Get them vibes" actionIcon={
              <IconButton color="primary"> <SvgIcon> <path d={Music}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
          <GridListTile className={classes.gridListTile}>
            ...
            <GridListTileBar title='Busywork' subtitle="Get up off that coach NOW" actionIcon={
              <IconButton color="primary"> <SvgIcon> <path d={Work}/> </SvgIcon> </IconButton>
            }></GridListTileBar>
          </GridListTile>
        </GridList>
      </div>
